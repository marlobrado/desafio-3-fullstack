...
import isValidUserUpdateMiddleware from "../middlewares/isValidUserUpdate.middleware";
...
userRoutes.patch('/:id',ensureAuthMiddleware, ensuereIsOwnerMiddleware, isValidUserUpdateMiddleware, isValidUUIDMiddleware, updateUserController)
